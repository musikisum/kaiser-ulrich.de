...
import { Heading, Text, Link, Divider, Button } from '@chakra-ui/react';
...
export default function Hmtm() {
  ...
  const [isContainer2025Visible, setContainer2025Visible] = useState(true);
  ...
  return <>
    ...
    <Text className='mt20'>
      2024 wurde ich darüber hinaus für mein Lehrengagement für die <Link href='/person/oep-oer'>Shortlist</Link> des internationalen <a href='https://awards.oeglobal.org/2024-finalists' className='underline'>Open Education Award for Excellence‹ 2024</a> von OE Global in der Kategorie ›Educator Award‹ nominiert. In dieser Ausschreibung hat die Open Music Academy der Kategorie <i>Open Infrastructure</i> den <a href='https://awards.oeglobal.org/awards/2024/open-infrastructure/open-music-academy/' className='underline'>Open Education Award for Excellence‹ 2024</a> gewonnen.
    </Text>
    <Divider mt='20px' mb='20px' h='1px' bg='gray' />
    <Button bgColor='orange' onClick={toggleContainer2024}>
        { !isContainer2024Visible ? "Bewerbung 2024 anzeigen" : "Bewerbung 2024 ausblenden" }
    </Button>
    ...
    <Button bgColor='green' color='white' onClick={toggleContainer2025}>
        { !isContainer2025Visible ? "Bewerbung 2025 anzeigen" : "Bewerbung 2025 ausblenden" }
    </Button>
