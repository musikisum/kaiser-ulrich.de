...
export default function Profil() {
  return <>
    ...
    <Text className='mt20'>
      Über die Programmierung und das Publizieren von OpenBooks bin ich seit 2011 auf die Themen freie Lizenzen bzw. <i>Open Educational Resources</i> (OER) gestoßen. 2014 habe ich dann erstmals eine Creative-Commons-Lizenz für mein OpenBook <i>Kostenlose Software für den Musikunterricht</i> gewählt und die Publikation als Open Educational Resource (OER) auf <a href='https://github.com/musikisum/OpenBook-KostenloseSoftware' className='underline'>GitHub zur Verfügung gestellt</a>. Spätestens seit der Corona-Pandemie bin ich ein überzeugter Anhänger einer umfassenden Open Educational Practise. Während das Thema in Deutschland und im Bereich der Musik nur sehr verhalten aufgenommen wird, finden meine Bemühungen mittlerweile internationale Anerkennung. 2024 wurde ich von <a href='https://www.oeglobal.org/' className='underline'>OE Global</a> für den <a href='https://awards.oeglobal.org/2024-finalists/' className='underline'>Open Education Award for Excellence 2024</a> in der Kategorie <i>Educator Award</i> auf der Shortlist nominiert. Meine Bewerbung können Sie auf meiner Seite zur <Link href='/person/oep-oer/' textDecoration={'underline'}>Open Education</Link> einsehen.
    </Text>
    <Text className='mt20'>
      Während und nach Corona (2020) sind zahlreiche staatliche Programme aufgelegt worden, in denen die Erstellung von OER und der Aufbau von OER-Communities gefördert wird. Ein von mir inhaltlich konzipierter und von der HMTM gestellter Antrag zur Förderung des Aufbaus einer <Link href='/projekte/openmusicacademy' className='underline'>Lernplattform für Musik (oer-lfm)</Link> bei der <a className='underline' href='https://stiftung-hochschullehre.de/' target='_blank'>Stiftung Innovation in der Hochschullehre</a> war erfolgreich. Seither arbeite ich als Projektleiter am Aufbau der <a className='underline' href='https://openmusic.academy' target='_blank'>Open Music Academy</a>, wobei mich dieses Projekt voraussichtlich noch bis Ende 2025 (und vielleicht noch darüber hinaus) vollkommen auslasten wird. 2024 wurde die Open Music Academy von <a href='https://www.oeglobal.org/' className='underline'>OE Global</a> mit dem <a href='https://awards.oeglobal.org/awards/2024/open-infrastructure/open-music-academy/' className='underline'>Open Education Award for Excellence 2024</a> in der Kategorie <i>Open Infrastructure</i> ausgezeichnet.
    </Text>
    <Text className='mt20'>
      Neben meiner Begeisterung für eine Open Education im Bereich der Musik haben sich im Laufe meines Arbeitslebens die Arbeitsschwerpunkte verschoben. Im Folgenden können Sie dazu mehr erfahren.
    </Text>
