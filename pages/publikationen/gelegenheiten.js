...
import { Heading, Divider, Text, Box, Accordion, AccordionItem, AccordionButton, AccordionPanel, Stack } from '@chakra-ui/react';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Interviews | Ulrich Kaiser" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
      <PageHeader options={options} />
      <Text mb='10' ml='4'>Hier finden Sie Interviews zu verschiedenen Anlässen.</Text>
