    ...
    <div className='content'>
      <div className='bcs'>
        <Breadcrumb>
          ...
          <Breadcrumb.Divider />
          <Breadcrumb.Section link><Link href="/publikationen/online">Online Artikel</Link></Breadcrumb.Section>
          <Breadcrumb.Divider />
          <Breadcrumb.Section active>Freiheit, Lehre &amp; Urheberrecht</Breadcrumb.Section>
        </Breadcrumb>
      </div>
      <div>
        ...
        <Image 
          as='a' 
          src='/images/Content-ID_Brahms-op93a-3.jpg' 
          href='https://www.youtube.com/watch?v=uroj2M-GRkA&ab_channel=UlrichKaiser' 
          target='_blank' 
          width='900' 
          height='600' 
        />
