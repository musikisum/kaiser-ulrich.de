...
const Wikimedia = () => {
  return (
    <>
      ...
      <Heading as='h2' size='md' mt='24px' mb='12px'>Ein Märchen</Heading>
      <Text mb='6px'>
      ...
      <Heading as='h2' size='md' mt='24px' mb='12px'>Geister angeln</Heading>
      <Text mb='6px'>
      ...
      <Heading as='h2' size='md' mt='24px' mb='12px'>Die Werke der Toten</Heading>
      <Text mb='6px'>
      ...
      <Heading as='h2' size='md' mt='24px' mb='12px'>Dein Video gehört jetzt mir</Heading>
      <Text mb='6px'>
      ...
      <Heading as='h2' size='md' mt='24px' mb='12px'>Keine Hilfe vom Schlossherrn</Heading>
      <Text mb='6px'>
      ...
      <Heading as='h2' size='md' mt='24px' mb='12px'>Düstere Aussichten</Heading>
      <Text mb='6px'>
      ...
      <Heading as='h2' size='md' mt='24px' mb='12px'>Reihenweise falsch erkannte Werke</Heading>
      <Text mb='6px'>
